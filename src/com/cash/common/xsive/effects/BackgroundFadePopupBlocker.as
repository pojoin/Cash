...
package com.cash.common.xsive.effects
{
	import mx.core.UIComponent;
	import com.cash.common.xsive.effects.BackgroundFade;
	...
	public class BackgroundFadePopupBlocker extends UIComponent
	{
	    ...
	    */
	   public static var FADE_TO : Number = 0.5;
	   ...
	   private function popUpRemoved(event:Event):void {
	      ...
	      //这里不应给设置等于null，因为和进度条冲突因此才进行的设置
