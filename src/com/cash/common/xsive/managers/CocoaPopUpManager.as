package com.cash.common.xsive.managers
{
	
	import com.cash.common.xsive.effects.BackgroundFadePopupBlocker;
	...
	public class CocoaPopUpManager
	{
	    ...
	    protected static var pHeight:int;
		...
		//	tween.toValue = window.y + slidepixels;
			tween.toValue = (pHeight - slidepixels)/2;
			tween.target = window;
