package com.cash.common.outsmart.dock.core
{
	...
	import com.cash.common.outsmart.fixeddrawer.core.FixedDrawer;	
	 ...
	 */
	[Event(name="dockItemClick", type="com.cash.common.outsmart.dock.events.DockItemEvent")]

	/**
	 * Dispatched when an the mouse initially moves over an item in the drawer.
	 */
	[Event(name="dockItemOver", type="com.cash.common.outsmart.dock.events.DockItemEvent")]

	/**
	 * Dispatched when an the mouse initially moves out of an item in the drawer.
	 */
	[Event(name="dockItemOut", type="com.cash.common.outsmart.dock.events.DockItemEvent")]
